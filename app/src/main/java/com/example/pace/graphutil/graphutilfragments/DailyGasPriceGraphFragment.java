...
public class DailyGasPriceGraphFragment extends Fragment {
    public DailyGasPriceGraphFragment() {
    }

    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_daily_gas_price_graph, container, false);
    ...
    private void initViews(View view) {
        this.lineChart = view.findViewById(R.id.daily_gasPrice_lineGraph);

        this.gasPriceValue = view.findViewById(R.id.daily_gasPrice_graph_value);
        this.gasPriceValue.setText("$ "+ListHolder.getInstance().outputDailyDataList.get(
        ...
        for (int i = 0; i < ListHolder.getInstance().outputDailyDataList.size(); ++i) {
            if (i == ListHolder.getInstance().outputDailyDataListIndex) {
                Entry entry = new Entry(
                        i, ListHolder.getInstance().outputDailyDataList.get(i).getAverageGasPrice()
                );
                this.gasPriceEntries.add(entry);
    ...
    public void addLineData() {
        ...
        for(int i = 0; i < this.gasPriceEntries.size(); ++i) {
            LineDataSet dsi = new LineDataSet(Collections.singletonList(this.gasPriceEntries.get(i)), null);
        ...
        LineDataSet dataSet = new LineDataSet(this.gasPriceEntries, null);
